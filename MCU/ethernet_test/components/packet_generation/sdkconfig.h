...
#define CONFIG_RADIATION_PACKET_NUMBER 150
#define CONFIG_RADIATION_PACKET_WAIT_TIME 100
#define CONFIG_HOUSEKEEPING_PACKET_PRIO 2
#define CONFIG_HOUSEKEEPING_PACKET_ID 0
#define CONFIG_BITFLIP_PACKET_PRIO 1
#define CONFIG_BITFLIP_PACKET_ID 1
#define CONFIG_RADIATION_PACKET_PRIO 3
#define CONFIG_RADIATION_PACKET_ID 2
#define CONFIG_ACKNOWLEDGEMENT_PACKET_PRIO 0
#define CONFIG_ACKNOWLEDGEMENT_PACKET_ID 3
#define CONFIG_CUT_OFF_TC_ID 3
// packet size config
#define CONFIG_ID_SIZE 2
#define CONFIG_SEQ_COUNTER_SIZE 16
#define CONFIG_RTC_SIZE 17
#define CONFIG_GNSS_SIZE 55
#define CONFIG_TEMP_SIZE 96           // Temperature data (3x32 bits = 96 bits)
#define CONFIG_ALT_SIZE 24            // Altitude data (24 bits)
#define CONFIG_BITFLIP_SIZE 172
#define CONFIG_RADIATION_SIZE 9984    // Changed from 9982
#define CONFIG_TC_SIZE 3
#define CONFIG_CRC_SIZE 16

// Update packet sizes to match structure
#define CONFIG_HOUSEKEEPING_PACKET_SIZE 32    // (250 + 7)/8 = 32 bytes
#define CONFIG_HOUSEKEEPING_DATA_SIZE 216     // 96 + 55 + 48 + 17 = 216 bits (Temp + GNSS + Alt + RTC)
#define CONFIG_BITFLIP_PACKET_SIZE 28         // (223 + 7)/8 = 28 bytes  
#define CONFIG_BITFLIP_DATA_SIZE 205          // 172 + 17 = 189 + 16 = 205 bits (BitFlip + RTC)
#define CONFIG_RADIATION_PACKET_SIZE 1255     // Keep as is
#define CONFIG_RADIATION_DATA_SIZE 10001      // 9984 + 17 = 10001 bits (Radiation + RTC)
#define CONFIG_ACKNOWLEDGEMENT_PACKET_SIZE 7  // (54 + 7)/8 = 7 bytes
#define CONFIG_ACKNOWLEDGEMENT_DATA_SIZE 20   // 3 + 17 = 20 bits (TC + RTC)
#define CONFIG_MAX_TC_BUFFER_SIZE 20
#define CONFIG_MAX_RADIATION_BUFFER_SIZE 350
#define CONFIG_UART_BAUD_RATE 115200
#define CONFIG_UART_NUM 0
#define CONFIG_TX_PIN 1
#define CONFIG_RX_PIN 3
#define CONFIG_UART_BUF_SIZE 1500
#define CONFIG_HOST_IP_ADDR "192.168.0.165"
...
#define CONFIG_ETH_BUFFER_SIZE 128
#define CONFIG_KEEPALIVE_ENABLED 1
