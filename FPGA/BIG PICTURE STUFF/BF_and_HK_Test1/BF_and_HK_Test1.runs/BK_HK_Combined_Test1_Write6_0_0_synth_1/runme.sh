...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/BIG PICTURE STUFF/BF_and_HK_Test1/BF_and_HK_Test1.runs/BK_HK_Combined_Test1_Write6_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BK_HK_Combined_Test1_Write6_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BK_HK_Combined_Test1_Write6_0_0.tcl
