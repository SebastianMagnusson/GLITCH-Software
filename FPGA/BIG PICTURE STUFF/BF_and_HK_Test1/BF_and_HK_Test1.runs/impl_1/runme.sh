...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/BIG PICTURE STUFF/BF_and_HK_Test1/BF_and_HK_Test1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BK_HK_Combined_Test1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BK_HK_Combined_Test1_wrapper.tcl -notrace
