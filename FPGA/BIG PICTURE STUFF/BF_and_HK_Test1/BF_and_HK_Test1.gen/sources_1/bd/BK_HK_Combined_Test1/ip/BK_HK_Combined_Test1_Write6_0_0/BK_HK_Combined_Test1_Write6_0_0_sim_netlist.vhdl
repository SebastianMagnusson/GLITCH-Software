...
-- Date        : Tue Sep 16 11:31:25 2025
-- Host        : LAPTOP-1SQM85NC running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim {c:/GitHub/GLITCH-Software/FPGA/BIG PICTURE
--               STUFF/BF_and_HK_Test1/BF_and_HK_Test1.gen/sources_1/bd/BK_HK_Combined_Test1/ip/BK_HK_Combined_Test1_Write6_0_0/BK_HK_Combined_Test1_Write6_0_0_sim_netlist.vhdl}
-- Design      : BK_HK_Combined_Test1_Write6_0_0
...
entity BK_HK_Combined_Test1_Write6_0_0_Write6 is
  port (
  ...
  attribute ORIG_REF_NAME of BK_HK_Combined_Test1_Write6_0_0_Write6 : entity is "Write6";
end BK_HK_Combined_Test1_Write6_0_0_Write6;

architecture STRUCTURE of BK_HK_Combined_Test1_Write6_0_0_Write6 is
  ...
  signal \addr_cnt_reg[12]_i_2_n_0\ : STD_LOGIC;
  signal \addr_cnt_reg[12]_i_2_n_1\ : STD_LOGIC;
  signal \addr_cnt_reg[12]_i_2_n_2\ : STD_LOGIC;
  signal \addr_cnt_reg[12]_i_2_n_3\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \addr_cnt[10]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \addr_cnt[11]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \addr_cnt[12]_i_1\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \addr_cnt[15]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \addr_cnt[16]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \addr_cnt[17]_i_1\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \addr_cnt[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \addr_cnt[20]_i_1\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \addr_cnt[8]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \addr_cnt[9]_i_1\ : label is "soft_lutpair11";
  attribute ADDER_THRESHOLD : integer;
  attribute ADDER_THRESHOLD of \addr_cnt_reg[12]_i_2\ : label is 35;
  ...
  attribute SOFT_HLUTNM of write_active_i_1 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of write_complete_i_1 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \write_data[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \write_data[10]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \write_data[12]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \write_data[14]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \write_data[15]_i_10\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \write_data[15]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \write_data[15]_i_5\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \write_data[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \write_data[4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \write_data[6]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \write_data[8]_i_1\ : label is "soft_lutpair5";
begin
...
\addr_cnt_reg[12]_i_2\: unisim.vcomponents.CARRY4
     port map (
      CI => \addr_cnt_reg[8]_i_2_n_0\,
      CO(3) => \addr_cnt_reg[12]_i_2_n_0\,
      CO(2) => \addr_cnt_reg[12]_i_2_n_1\,
      CO(1) => \addr_cnt_reg[12]_i_2_n_2\,
      CO(0) => \addr_cnt_reg[12]_i_2_n_3\,
      CYINIT => '0',
...
\write_data[15]_i_10\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\write_data[15]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
        ...
        port map (
      I0 => \write_data[15]_i_7_n_0\,
      I1 => \write_data[15]_i_9_n_0\,
      I2 => \write_data[15]_i_10_n_0\,
      I3 => \write_data[15]_i_11_n_0\,
      I4 => \write_data[15]_i_12_n_0\,
      O => \write_data[15]_i_8_n_0\
    );
\write_data[15]_i_9\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity BK_HK_Combined_Test1_Write6_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
    write_complete : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of BK_HK_Combined_Test1_Write6_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of BK_HK_Combined_Test1_Write6_0_0 : entity is "BK_HK_Combined_Test1_Write6_0_0,Write6,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of BK_HK_Combined_Test1_Write6_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of BK_HK_Combined_Test1_Write6_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of BK_HK_Combined_Test1_Write6_0_0 : entity is "Write6,Vivado 2024.2";
end BK_HK_Combined_Test1_Write6_0_0;

architecture STRUCTURE of BK_HK_Combined_Test1_Write6_0_0 is
...
begin
  ...
  DQ_t(1) <= \^dq_t\(0);
  DQ_t(0) <= \^dq_t\(0);
U0: entity work.BK_HK_Combined_Test1_Write6_0_0_Write6
     port map (
