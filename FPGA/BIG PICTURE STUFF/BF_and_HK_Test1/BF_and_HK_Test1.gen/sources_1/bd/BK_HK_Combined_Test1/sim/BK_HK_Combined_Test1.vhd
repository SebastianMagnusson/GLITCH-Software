...
--Command     : generate_target BK_HK_Combined_Test1.bd
--Design      : BK_HK_Combined_Test1
...
entity BK_HK_Combined_Test1 is
  port (
  ...
  attribute CORE_GENERATION_INFO of BK_HK_Combined_Test1 : entity is "BK_HK_Combined_Test1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=BK_HK_Combined_Test1,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=14,numReposBlks=14,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=14,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of BK_HK_Combined_Test1 : entity is "BK_HK_Combined_Test1.hwdef";
end BK_HK_Combined_Test1;

architecture STRUCTURE of BK_HK_Combined_Test1 is
  component BK_HK_Combined_Test1_BF_Data_Collector_Dr_0_0 is
  port (
    sysclk : in STD_LOGIC;
  ...
  end component BK_HK_Combined_Test1_BF_Data_Collector_Dr_0_0;
  component BK_HK_Combined_Test1_BF_formatter_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
  ...
  end component BK_HK_Combined_Test1_BF_formatter_0_0;
  component BK_HK_Combined_Test1_GNSS_Fetcher_mod_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
  ...
  end component BK_HK_Combined_Test1_GNSS_Fetcher_mod_0_0;
  component BK_HK_Combined_Test1_GNSS_Sender_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
    data_ready : in STD_LOGIC;
  ...
  end component BK_HK_Combined_Test1_GNSS_Sender_0_0;
  component BK_HK_Combined_Test1_HK_formatter_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
  ...
  end component BK_HK_Combined_Test1_HK_formatter_0_0;
  component BK_HK_Combined_Test1_I2C_full_sensor_data_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
    i_busy : in STD_LOGIC;
  ...
  end component BK_HK_Combined_Test1_I2C_full_sensor_data_0_0;
  component BK_HK_Combined_Test1_I2Cmod_0_0 is
  port (
    sda_i : in STD_LOGIC;
    sda_o : out STD_LOGIC;
    sda_t : out STD_LOGIC;
  ...
  end component BK_HK_Combined_Test1_I2Cmod_0_0;
  component BK_HK_Combined_Test1_Read6_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
  ...
  end component BK_HK_Combined_Test1_Read6_0_0;
  component BK_HK_Combined_Test1_RW_ROUTER4_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
    led1 : out STD_LOGIC;
  ...
  end component BK_HK_Combined_Test1_RW_ROUTER4_0_0;
  component BK_HK_Combined_Test1_Switchmod_0_0 is
  port (
    sysclk : in STD_LOGIC;
  ...
  end component BK_HK_Combined_Test1_Switchmod_0_0;
  component BK_HK_Combined_Test1_TM_packet_sender_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
  ...
  end component BK_HK_Combined_Test1_TM_packet_sender_0_0;
  component BK_HK_Combined_Test1_UART_RXmod_0_0 is
  port (
    sysclk : in STD_LOGIC;
  ...
  end component BK_HK_Combined_Test1_UART_RXmod_0_0;
  component BK_HK_Combined_Test1_UART_TXmod_0_0 is
  port (
    sysclk : in STD_LOGIC;
  ...
  end component BK_HK_Combined_Test1_UART_TXmod_0_0;
  component BK_HK_Combined_Test1_Write6_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
  ...
  end component BK_HK_Combined_Test1_Write6_0_0;
...
begin
BF_Data_Collector_Dr_0: component BK_HK_Combined_Test1_BF_Data_Collector_Dr_0_0
     port map (
...
BF_formatter_0: component BK_HK_Combined_Test1_BF_formatter_0_0
     port map (
...
GNSS_Fetcher_mod_0: component BK_HK_Combined_Test1_GNSS_Fetcher_mod_0_0
     port map (
...
GNSS_Sender_0: component BK_HK_Combined_Test1_GNSS_Sender_0_0
     port map (
...
HK_formatter_0: component BK_HK_Combined_Test1_HK_formatter_0_0
     port map (
...
I2C_full_sensor_data_0: component BK_HK_Combined_Test1_I2C_full_sensor_data_0_0
     port map (
      clk => sysclk,
...
I2Cmod_0: component BK_HK_Combined_Test1_I2Cmod_0_0
     port map (
...
RW_ROUTER4_0: component BK_HK_Combined_Test1_RW_ROUTER4_0_0
     port map (
...
Read6_0: component BK_HK_Combined_Test1_Read6_0_0
     port map (
...
Switchmod_0: component BK_HK_Combined_Test1_Switchmod_0_0
     port map (
      i_signal => btn0,
      led0 => led0,
      o_signal => reset_n_0_1,
      sysclk => sysclk
    );
TM_packet_sender_0: component BK_HK_Combined_Test1_TM_packet_sender_0_0
     port map (
      clk => sysclk,
...
UART_RXmod_0: component BK_HK_Combined_Test1_UART_RXmod_0_0
     port map (
      i_RX_Serial => GNSS_TX,
...
UART_TXmod_0: component BK_HK_Combined_Test1_UART_TXmod_0_0
     port map (
...
Write6_0: component BK_HK_Combined_Test1_Write6_0_0
     port map (
