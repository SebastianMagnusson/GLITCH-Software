...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/BIG PICTURE STUFF/FPGA_to_MCU_Test1/FPGA_to_MCU_Test1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Fpga_and_MCU_Test1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Fpga_and_MCU_Test1_wrapper.tcl -notrace
