...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/BIG PICTURE STUFF/FPGA_to_MCU_Test1/FPGA_to_MCU_Test1.runs/Fpga_and_MCU_Test1_I2Cmod_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fpga_and_MCU_Test1_I2Cmod_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fpga_and_MCU_Test1_I2Cmod_0_0.tcl
