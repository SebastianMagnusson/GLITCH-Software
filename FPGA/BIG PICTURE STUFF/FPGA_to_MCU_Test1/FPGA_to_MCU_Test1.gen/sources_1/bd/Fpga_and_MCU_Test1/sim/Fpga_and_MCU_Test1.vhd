...
--Command     : generate_target Fpga_and_MCU_Test1.bd
--Design      : Fpga_and_MCU_Test1
...
entity Fpga_and_MCU_Test1 is
  ...
  attribute CORE_GENERATION_INFO of Fpga_and_MCU_Test1 : entity is "Fpga_and_MCU_Test1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=Fpga_and_MCU_Test1,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=17,numReposBlks=17,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=17,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of Fpga_and_MCU_Test1 : entity is "Fpga_and_MCU_Test1.hwdef";
end Fpga_and_MCU_Test1;

architecture STRUCTURE of Fpga_and_MCU_Test1 is
  component Fpga_and_MCU_Test1_BF_Data_Collector_Dr_0_0 is
  port (
    sysclk : in STD_LOGIC;
  ...
  end component Fpga_and_MCU_Test1_BF_Data_Collector_Dr_0_0;
  component Fpga_and_MCU_Test1_BF_formatter_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
  ...
  end component Fpga_and_MCU_Test1_BF_formatter_0_0;
  component Fpga_and_MCU_Test1_GNSS_Fetcher_mod_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
  ...
  end component Fpga_and_MCU_Test1_GNSS_Fetcher_mod_0_0;
  component Fpga_and_MCU_Test1_GNSS_Sender_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
    data_ready : in STD_LOGIC;
  ...
  end component Fpga_and_MCU_Test1_GNSS_Sender_0_0;
  component Fpga_and_MCU_Test1_HK_formatter_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
  ...
  end component Fpga_and_MCU_Test1_HK_formatter_0_0;
  component Fpga_and_MCU_Test1_I2C_full_sensor_data_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
    i_busy : in STD_LOGIC;
  ...
  end component Fpga_and_MCU_Test1_I2C_full_sensor_data_0_0;
  component Fpga_and_MCU_Test1_I2Cmod_0_0 is
  port (
    sda_i : in STD_LOGIC;
    sda_o : out STD_LOGIC;
    sda_t : out STD_LOGIC;
  ...
  end component Fpga_and_MCU_Test1_I2Cmod_0_0;
  component Fpga_and_MCU_Test1_Pulse_Per_Second_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
  ...
  end component Fpga_and_MCU_Test1_Pulse_Per_Second_0_0;
  component Fpga_and_MCU_Test1_Read7_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
  ...
  end component Fpga_and_MCU_Test1_Read7_0_0;
  component Fpga_and_MCU_Test1_RW_ROUTER4_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
    led1 : out STD_LOGIC;
  ...
  end component Fpga_and_MCU_Test1_RW_ROUTER4_0_0;
  component Fpga_and_MCU_Test1_Switchmod_0_0 is
  port (
    sysclk : in STD_LOGIC;
  ...
  end component Fpga_and_MCU_Test1_Switchmod_0_0;
  component Fpga_and_MCU_Test1_TM_packet_sender_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
  ...
  end component Fpga_and_MCU_Test1_TM_packet_sender_0_0;
  component Fpga_and_MCU_Test1_UART_RXmod_0_0 is
  port (
    sysclk : in STD_LOGIC;
  ...
  end component Fpga_and_MCU_Test1_UART_RXmod_0_0;
  component Fpga_and_MCU_Test1_UART_TXmod_0_0 is
  port (
    sysclk : in STD_LOGIC;
  ...
  end component Fpga_and_MCU_Test1_UART_TXmod_0_0;
  component Fpga_and_MCU_Test1_Write7_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
  ...
  end component Fpga_and_MCU_Test1_Write7_0_0;
  component Fpga_and_MCU_Test1_TC_distributor_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
  ...
  end component Fpga_and_MCU_Test1_TC_distributor_0_0;
  component Fpga_and_MCU_Test1_UART_RXmod_1_0 is
  port (
    sysclk : in STD_LOGIC;
    i_RX_Serial : in STD_LOGIC;
    o_RX_DV : out STD_LOGIC;
  ...
  end component Fpga_and_MCU_Test1_UART_RXmod_1_0;
  ...
  signal \^uart_tx_to_mcu\ : STD_LOGIC;
  ...
  signal NLW_Pulse_Per_Second_0_led0_UNCONNECTED : STD_LOGIC;
  signal NLW_RW_ROUTER4_0_WE_n_UNCONNECTED : STD_LOGIC;
...
begin
  uart_rxd_out <= \^uart_tx_to_mcu\;
  uart_tx_to_mcu <= \^uart_tx_to_mcu\;
BF_Data_Collector_Dr_0: component Fpga_and_MCU_Test1_BF_Data_Collector_Dr_0_0
     port map (
...
BF_formatter_0: component Fpga_and_MCU_Test1_BF_formatter_0_0
     port map (
...
GNSS_Fetcher_mod_0: component Fpga_and_MCU_Test1_GNSS_Fetcher_mod_0_0
     port map (
...
GNSS_Sender_0: component Fpga_and_MCU_Test1_GNSS_Sender_0_0
     port map (
...
HK_formatter_0: component Fpga_and_MCU_Test1_HK_formatter_0_0
     port map (
...
I2C_full_sensor_data_0: component Fpga_and_MCU_Test1_I2C_full_sensor_data_0_0
     port map (
      clk => sysclk,
...
I2Cmod_0: component Fpga_and_MCU_Test1_I2Cmod_0_0
     port map (
...
Pulse_Per_Second_0: component Fpga_and_MCU_Test1_Pulse_Per_Second_0_0
     port map (
      led0 => NLW_Pulse_Per_Second_0_led0_UNCONNECTED,
      o_pulse => Pulse_Per_Second_0_o_pulse,
      reset_n => Switchmod_0_o_signal,
      sysclk => sysclk
    );
RW_ROUTER4_0: component Fpga_and_MCU_Test1_RW_ROUTER4_0_0
     port map (
      ...
      WE_n => NLW_RW_ROUTER4_0_WE_n_UNCONNECTED,
...
Read7_0: component Fpga_and_MCU_Test1_Read7_0_0
     port map (
...
Switchmod_0: component Fpga_and_MCU_Test1_Switchmod_0_0
     port map (
...
TC_distributor_0: component Fpga_and_MCU_Test1_TC_distributor_0_0
     port map (
      TC(7 downto 0) => UART_RXmod_1_o_RX_byte(7 downto 0),
      TC_DV => UART_RXmod_1_o_RX_DV,
      clk => sysclk,
...
TM_packet_sender_0: component Fpga_and_MCU_Test1_TM_packet_sender_0_0
     port map (
      clk => sysclk,
...
UART_RXmod_0: component Fpga_and_MCU_Test1_UART_RXmod_0_0
     port map (
      i_RX_Serial => GNSS_TX,
...
UART_RXmod_1: component Fpga_and_MCU_Test1_UART_RXmod_1_0
     port map (
      i_RX_Serial => uart_rx_from_mcu,
      o_RX_DV => UART_RXmod_1_o_RX_DV,
      o_RX_byte(7 downto 0) => UART_RXmod_1_o_RX_byte(7 downto 0),
      sysclk => sysclk
    );
UART_TXmod_0: component Fpga_and_MCU_Test1_UART_TXmod_0_0
     port map (
      ...
      o_TX_Serial => \^uart_tx_to_mcu\,
      sysclk => sysclk
    );
Write7_0: component Fpga_and_MCU_Test1_Write7_0_0
     port map (
