...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/BIG PICTURE STUFF/Program_MCU/Program_MCU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Program_MCU_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Program_MCU_wrapper.tcl -notrace
