...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/BIG PICTURE STUFF/Program_MCU/Program_MCU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Program_MCU_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Program_MCU_wrapper.tcl
