...
# testing if 15 and 16 works as digital pins
# Use DIP pin 15 as digital I/O (use AD4P or AD4N; AD4P typically used for single-ended)
#set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { uart_tx_to_mcu }]; # IO_L1P_T0_AD4P_35

# Use DIP pin 16 as digital I/O (use AD12P or AD12N; AD12P typically used for single-ended)
#set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { uart_rx }]; # IO_L2P_T0_AD12P_35
...
set_property -dict { PACKAGE_PIN M3    IOSTANDARD LVCMOS33 } [get_ports { MCU_tx  }]; #IO_L8N_T1_AD14N_35 Sch=pio[01]
set_property -dict { PACKAGE_PIN L3    IOSTANDARD LVCMOS33 } [get_ports { MCU_rx  }]; #IO_L8P_T1_AD14P_35 Sch=pio[02]
...
# this is for testing restart telecommand
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { uart_rx_from_mcu }]; #IO_L14N_T2_SRCC_34 Sch=pio[48]
