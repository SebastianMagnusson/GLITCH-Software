...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/UART/GNSS_Fetcher_Test/GNSS_Fetcher_Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fetch_gnns_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fetch_gnns_1_wrapper.tcl -notrace
