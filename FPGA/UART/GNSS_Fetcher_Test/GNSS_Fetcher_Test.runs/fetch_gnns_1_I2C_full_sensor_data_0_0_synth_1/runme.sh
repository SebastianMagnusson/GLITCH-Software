...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/UART/GNSS_Fetcher_Test/GNSS_Fetcher_Test.runs/fetch_gnns_1_I2C_full_sensor_data_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fetch_gnns_1_I2C_full_sensor_data_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fetch_gnns_1_I2C_full_sensor_data_0_0.tcl
