...
#
# Script generated by Vivado on Fri Sep 12 17:37:11 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Func_test1_wrapper.sh
...
#
# Usage        : Func_test1_wrapper.sh
#                Func_test1_wrapper.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Func_test1_wrapper.sh [-reset_run]
#                Func_test1_wrapper.sh [-reset_log]
#                Func_test1_wrapper.sh [-help]
#
...
# script info
echo -e "Func_test1_wrapper.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Func_test1_wrapper.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip --snapshot Func_test1_wrapper xil_defaultlib.Func_test1_wrapper -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Func_test1_wrapper -key {Behavioral:sim_1:Functional:Func_test1_wrapper} -tclbatch cmd.tcl -protoinst "protoinst_files/Func_test1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Func_test1_wrapper.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Func_test1_wrapper.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Func_test1_wrapper.sh [-help]\n\
Usage: Func_test1_wrapper.sh [-step]\n\
Usage: Func_test1_wrapper.sh [-lib_map_path]\n\
Usage: Func_test1_wrapper.sh [-reset_run]\n\
Usage: Func_test1_wrapper.sh [-reset_log]\n\
Usage: Func_test1_wrapper.sh [-keep_index]\n\
Usage: Func_test1_wrapper.sh [-noclean_files]\n\n\
