...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/SRAM TESTING/SRAM_Breadboard_Test6/SRAM_Breadboard_Test6.runs/Func_test1_RW_ROUTER4_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Func_test1_RW_ROUTER4_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Func_test1_RW_ROUTER4_0_0.tcl
