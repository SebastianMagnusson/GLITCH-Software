...
entity Func_test1_TM_packet_sender_0_0 is
  ...
  attribute CHECK_LICENSE_TYPE of Func_test1_TM_packet_sender_0_0 : entity is "Func_test1_TM_packet_sender_0_0,TM_packet_sender,{}";
  attribute core_generation_info : string;
  attribute core_generation_info of Func_test1_TM_packet_sender_0_0 : entity is "Func_test1_TM_packet_sender_0_0,TM_packet_sender,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=TM_packet_sender,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VHDL,x_ipSimLanguage=VHDL,Clockfrequency=12000000,Baud_Rate=400000}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of Func_test1_TM_packet_sender_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of Func_test1_TM_packet_sender_0_0 : entity is "module_ref";
end Func_test1_TM_packet_sender_0_0;

architecture stub of Func_test1_TM_packet_sender_0_0 is
