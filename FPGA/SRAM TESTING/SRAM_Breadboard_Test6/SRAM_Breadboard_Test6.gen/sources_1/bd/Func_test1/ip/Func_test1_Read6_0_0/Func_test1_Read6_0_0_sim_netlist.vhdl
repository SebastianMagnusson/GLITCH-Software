...
--               TESTING/SRAM_Breadboard_Test6/SRAM_Breadboard_Test6.gen/sources_1/bd/Func_test1/ip/Func_test1_Read6_0_0/Func_test1_Read6_0_0_sim_netlist.vhdl}
...
entity Func_test1_Read6_0_0_Read6 is
  port (
  ...
  attribute ORIG_REF_NAME of Func_test1_Read6_0_0_Read6 : entity is "Read6";
end Func_test1_Read6_0_0_Read6;

architecture STRUCTURE of Func_test1_Read6_0_0_Read6 is
  signal \A[21]_i_1_n_0\ : STD_LOGIC;
  signal A_buf : STD_LOGIC;
  signal BF_data_buf0 : STD_LOGIC;
  ...
  signal in13 : STD_LOGIC_VECTOR ( 46 downto 9 );
  signal in17 : STD_LOGIC_VECTOR ( 21 downto 1 );
  signal \^led0\ : STD_LOGIC;
  signal led0_i_1_n_0 : STD_LOGIC;
  signal loop_cnt : STD_LOGIC_VECTOR ( 3 downto 1 );
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state[10]_i_5\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \addr_cnt[12]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \addr_cnt[13]_i_1\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \addr_cnt[16]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \addr_cnt[17]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \addr_cnt[18]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \addr_cnt[19]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \addr_cnt[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \addr_cnt[20]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \addr_cnt[2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \addr_cnt[3]_i_1\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \addr_cnt[8]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \addr_cnt[9]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of bitflip_flag_i_2 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of data_rewritten_flag_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of led0_i_1 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \loop_cnt[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \loop_cnt[2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \loop_cnt[3]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \loop_cnt[3]_i_3\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of o_BF_drive_i_1 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \osc_cnt[0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \osc_cnt[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \osc_cnt[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \osc_cnt[3]_i_2\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of read_complete_i_1 : label is "soft_lutpair9";
...
\BF_data_buf[46]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1000"
    )
        port map (
...
\FSM_onehot_state[10]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\FSM_onehot_state[10]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
bitflip_flag_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"5F30"
    )
        port map (
...
bitflip_flag_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1000"
    )
        port map (
...
\loop_cnt[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF10"
    )
        port map (
...
\osc_cnt[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Func_test1_Read6_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of Func_test1_Read6_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Func_test1_Read6_0_0 : entity is "Func_test1_Read6_0_0,Read6,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of Func_test1_Read6_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of Func_test1_Read6_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of Func_test1_Read6_0_0 : entity is "Read6,Vivado 2024.2";
end Func_test1_Read6_0_0;

architecture STRUCTURE of Func_test1_Read6_0_0 is
...
U0: entity work.Func_test1_Read6_0_0_Read6
     port map (
