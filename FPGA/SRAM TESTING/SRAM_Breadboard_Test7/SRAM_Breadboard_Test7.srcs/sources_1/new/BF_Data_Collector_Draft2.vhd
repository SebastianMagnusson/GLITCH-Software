...
architecture rtl of BF_Data_Collector_Draft2 is
  ...
  signal data_ready_prev_0 : std_logic := '0';
  signal data_ready_prev_1 : std_logic := '0';
  ...
  begin
    ...
    if (reset_n = '0') then
      ...
      case i_dump is  -- i_dump is high 1 clc cycle every second. (Dumps one time per second)
        ...
        when '0' => -- RECEIVE
          o_BF_drive        <= '0';
          data_ready_prev_0 <= data_ready_0;
          data_ready_prev_1 <= data_ready_1;
          ...
          if(just_dumped = '1') then                              -- Cleans up previous data
          ...
          elsif(data_ready_prev_0 = '0' and data_ready_0 = '1') then  -- New bitflip data
            ...
            case flip_cnt is 
              when 0 =>                                  -- 1 bitflip
                ...
                BF_data_buf(187 downto 141) <= i_BF_data_0;
                flip_cnt                    <= flip_cnt + 1;
              
              when 1 =>                                  -- 2 bitflips
                BF_data_buf(189 downto 188) <= "10";
                BF_data_buf(140 downto 94)  <= i_BF_data_0;
                flip_cnt                    <= flip_cnt + 1;
              
              when 2 =>                                  -- 3 bitflips
                BF_data_buf(189 downto 188) <= "11";
                BF_data_buf(93 downto 47)   <= i_BF_data_0;
                flip_cnt                    <= flip_cnt + 1;
              
              when 3 =>                                  -- 4 bitflips
                BF_data_buf(189 downto 188) <= "11";
                BF_data_buf(46 downto 0)    <= i_BF_data_0;
                flip_cnt                    <= flip_cnt + 1;
          ...
          elsif(data_ready_prev_1 = '0' and data_ready_1 = '1') then  -- New bitflip data
            ...
            case flip_cnt is 
              when 0 =>                                  -- 1 bitflip
                ...
                BF_data_buf(187 downto 141) <= i_BF_data_1;
                flip_cnt                    <= flip_cnt + 1;
              
              when 1 =>                                  -- 2 bitflips
                BF_data_buf(189 downto 188) <= "01";
                BF_data_buf(140 downto 94)  <= i_BF_data_1;
                flip_cnt                    <= flip_cnt + 1;
              
              when 2 =>                                  -- 3 bitflips
                BF_data_buf(189 downto 188) <= "10";
                BF_data_buf(93 downto 47)   <= i_BF_data_1;
                flip_cnt                    <= flip_cnt + 1;
              
              when 3 =>                                  -- 4 bitflips
                BF_data_buf(189 downto 188) <= "11";
                BF_data_buf(46 downto 0)    <= i_BF_data_1;
                flip_cnt                    <= flip_cnt + 1;
