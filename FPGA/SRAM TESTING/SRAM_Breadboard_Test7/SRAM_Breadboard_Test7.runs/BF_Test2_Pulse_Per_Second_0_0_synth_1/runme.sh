...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/SRAM TESTING/SRAM_Breadboard_Test7/SRAM_Breadboard_Test7.runs/BF_Test2_Pulse_Per_Second_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BF_Test2_Pulse_Per_Second_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BF_Test2_Pulse_Per_Second_0_0.tcl
