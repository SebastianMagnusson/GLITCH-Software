...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/SRAM TESTING/SRAM_Breadboard_Test7/SRAM_Breadboard_Test7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BF_Test2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BF_Test2_wrapper.tcl
