...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/SRAM TESTING/SRAM_Breadboard_Test7/SRAM_Breadboard_Test7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BF_Test2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BF_Test2_wrapper.tcl -notrace
