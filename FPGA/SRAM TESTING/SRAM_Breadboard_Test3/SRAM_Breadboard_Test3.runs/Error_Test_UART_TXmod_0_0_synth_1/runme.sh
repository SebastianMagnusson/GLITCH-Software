...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/SRAM TESTING/SRAM_Breadboard_Test3/SRAM_Breadboard_Test3.runs/Error_Test_UART_TXmod_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Error_Test_UART_TXmod_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Error_Test_UART_TXmod_0_0.tcl
