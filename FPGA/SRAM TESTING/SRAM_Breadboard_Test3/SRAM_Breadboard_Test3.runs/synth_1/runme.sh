...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/SRAM TESTING/SRAM_Breadboard_Test3/SRAM_Breadboard_Test3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Error_Test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Error_Test_wrapper.tcl
