...
-- Date        : Mon Sep  8 09:40:47 2025
-- Host        : LAPTOP-1SQM85NC running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim {c:/GitHub/GLITCH-Software/FPGA/SRAM
--               TESTING/SRAM_Breadboard_Test3/SRAM_Breadboard_Test3.gen/sources_1/bd/Error_Test/ip/Error_Test_RW_ROUTER_0_0/Error_Test_RW_ROUTER_0_0_sim_netlist.vhdl}
-- Design      : Error_Test_RW_ROUTER_0_0
...
entity Error_Test_RW_ROUTER_0_0_RW_ROUTER is
  port (
    led1 : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of Error_Test_RW_ROUTER_0_0_RW_ROUTER : entity is "RW_ROUTER";
end Error_Test_RW_ROUTER_0_0_RW_ROUTER;

architecture STRUCTURE of Error_Test_RW_ROUTER_0_0_RW_ROUTER is
  ...
  attribute SOFT_HLUTNM of CE_n_i_1 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \DQ_t[0]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \DQ_t[10]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \DQ_t[11]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \DQ_t[12]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \DQ_t[13]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \DQ_t[14]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \DQ_t[15]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \DQ_t[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \DQ_t[2]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \DQ_t[3]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \DQ_t[4]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \DQ_t[5]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \DQ_t[6]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \DQ_t[7]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \DQ_t[8]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \DQ_t[9]_i_1\ : label is "soft_lutpair15";
...
\DQ_o[15]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity Error_Test_RW_ROUTER_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
    led1 : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of Error_Test_RW_ROUTER_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Error_Test_RW_ROUTER_0_0 : entity is "Error_Test_RW_ROUTER_0_0,RW_ROUTER,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of Error_Test_RW_ROUTER_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of Error_Test_RW_ROUTER_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of Error_Test_RW_ROUTER_0_0 : entity is "RW_ROUTER,Vivado 2024.2";
end Error_Test_RW_ROUTER_0_0;

architecture STRUCTURE of Error_Test_RW_ROUTER_0_0 is
...
begin
U0: entity work.Error_Test_RW_ROUTER_0_0_RW_ROUTER
     port map (
