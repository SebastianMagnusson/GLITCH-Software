...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/SRAM TESTING/SRAM_Breadboard_Test5/SRAM_Breadboard_Test5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log loop_test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source loop_test_wrapper.tcl -notrace
