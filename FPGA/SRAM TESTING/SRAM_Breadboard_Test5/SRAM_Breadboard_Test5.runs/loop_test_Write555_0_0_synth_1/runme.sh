...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/SRAM TESTING/SRAM_Breadboard_Test5/SRAM_Breadboard_Test5.runs/loop_test_Write555_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log loop_test_Write555_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source loop_test_Write555_0_0.tcl
