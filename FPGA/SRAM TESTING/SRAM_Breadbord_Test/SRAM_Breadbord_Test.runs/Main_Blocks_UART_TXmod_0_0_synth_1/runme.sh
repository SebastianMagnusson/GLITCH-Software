...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/I2C/SRAM_Breadbord_Test/SRAM_Breadbord_Test.runs/Main_Blocks_UART_TXmod_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_Blocks_UART_TXmod_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Main_Blocks_UART_TXmod_0_0.tcl
