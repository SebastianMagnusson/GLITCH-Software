...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/I2C/SRAM_Breadbord_Test/SRAM_Breadbord_Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_Blocks_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Main_Blocks_wrapper.tcl -notrace
