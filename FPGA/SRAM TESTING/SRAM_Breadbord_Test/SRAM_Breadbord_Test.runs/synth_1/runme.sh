...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/I2C/SRAM_Breadbord_Test/SRAM_Breadbord_Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_Blocks_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Main_Blocks_wrapper.tcl
