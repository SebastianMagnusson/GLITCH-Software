...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/SRAM TESTING/SRAM_Breadbord_Test_2/SRAM_Breadbord_Test_2.runs/Alg_Test1_RW_ROUTER_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Alg_Test1_RW_ROUTER_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Alg_Test1_RW_ROUTER_0_0.tcl
