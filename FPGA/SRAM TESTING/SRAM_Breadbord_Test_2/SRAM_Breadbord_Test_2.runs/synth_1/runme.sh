...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/SRAM TESTING/SRAM_Breadbord_Test_2/SRAM_Breadbord_Test_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Alg_Test1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Alg_Test1_wrapper.tcl
