...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/SRAM TESTING/SRAM_Breadbord_Test_2/SRAM_Breadbord_Test_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Alg_Test1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Alg_Test1_wrapper.tcl -notrace
