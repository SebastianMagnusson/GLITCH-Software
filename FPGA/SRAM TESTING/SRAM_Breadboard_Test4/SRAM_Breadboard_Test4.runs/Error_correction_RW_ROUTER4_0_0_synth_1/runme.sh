...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/SRAM TESTING/SRAM_Breadboard_Test4/SRAM_Breadboard_Test4.runs/Error_correction_RW_ROUTER4_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Error_correction_RW_ROUTER4_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Error_correction_RW_ROUTER4_0_0.tcl
