...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/SRAM TESTING/SRAM_Breadboard_Test4/SRAM_Breadboard_Test4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Error_correction_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Error_correction_wrapper.tcl -notrace
