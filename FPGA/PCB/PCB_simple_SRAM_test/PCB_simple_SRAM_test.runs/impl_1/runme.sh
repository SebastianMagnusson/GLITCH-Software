...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/PCB/PCB_simple_SRAM_test/PCB_simple_SRAM_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_PCB_test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simple_PCB_test_wrapper.tcl -notrace
