...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/PCB/PCB_simple_SRAM_test/PCB_simple_SRAM_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_PCB_test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_PCB_test_wrapper.tcl
