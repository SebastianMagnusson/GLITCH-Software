...
entity testwith1speed is
  ...
  attribute CORE_GENERATION_INFO of testwith1speed : entity is "testwith1speed,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=testwith1speed,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=23,numReposBlks=23,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=23,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}";
...
architecture STRUCTURE of testwith1speed is
  ...
  component testwith1speed_UART_RX_100MHZ_2_0 is
  port (
    sysclk : in STD_LOGIC;
    i_RX_Serial : in STD_LOGIC;
    o_RX_DV : out STD_LOGIC;
  ...
  end component testwith1speed_UART_RX_100MHZ_2_0;
  component testwith1speed_RAD_formatter_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
  ...
  end component testwith1speed_RAD_formatter_0_0;
  ...
  signal I2C_full_sensor_data_0_o_TX_DV_RAD : STD_LOGIC;
  ...
  signal RAD_formatter_0_I2C_read_done : STD_LOGIC;
  signal RAD_formatter_0_RAD_packet : STD_LOGIC_VECTOR ( 5015 downto 0 );
  signal RAD_formatter_0_RAD_packet_DV : STD_LOGIC;
  signal RAD_formatter_0_RTC_request : STD_LOGIC;
  ...
  signal TM_packet_sender_0_o_RAD_got : STD_LOGIC;
  ...
  signal UART_RX_100MHZ_2_o_RX_DV : STD_LOGIC;
  signal UART_RX_100MHZ_2_o_RX_byte : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal NLW_RAD_formatter_0_led0_UNCONNECTED : STD_LOGIC;
  signal NLW_RAD_formatter_0_led1_UNCONNECTED : STD_LOGIC;
  ...
  signal NLW_Read1_100MHZ_0_led2_UNCONNECTED : STD_LOGIC;
  ...
  signal NLW_UART_RX_100MHZ_2_led0_UNCONNECTED : STD_LOGIC;
begin
...
I2C_full_sensor_data_0: component testwith1speed_I2C_full_sensor_data_0_0
     port map (
      ...
      o_TX_DV_RAD => I2C_full_sensor_data_0_o_TX_DV_RAD,
...
RAD_formatter_0: component testwith1speed_RAD_formatter_0_0
     port map (
      I2C_read_done => RAD_formatter_0_I2C_read_done,
      RAD_data(7 downto 0) => UART_RX_100MHZ_2_o_RX_byte(7 downto 0),
      RAD_data_DV => UART_RX_100MHZ_2_o_RX_DV,
      RAD_packet(5015 downto 0) => RAD_formatter_0_RAD_packet(5015 downto 0),
      RAD_packet_DV => RAD_formatter_0_RAD_packet_DV,
      RAD_packet_got => TM_packet_sender_0_o_RAD_got,
      RTC_data(23 downto 0) => I2C_full_sensor_data_0_o_TX_RTC_data(23 downto 0),
      RTC_data_DV => I2C_full_sensor_data_0_o_TX_DV_RAD,
      RTC_request => RAD_formatter_0_RTC_request,
      clk => sysclk,
      led0 => NLW_RAD_formatter_0_led0_UNCONNECTED,
      led1 => NLW_RAD_formatter_0_led1_UNCONNECTED,
      led2 => led3,
      rst => Switchmod_0_o_signal
    );
...
Read1_100MHZ_0: component testwith1speed_Read1_100MHZ_0_0
     port map (
      ...
      led1 => led2,
      led2 => NLW_Read1_100MHZ_0_led2_UNCONNECTED,
...
TM_packet_sender_0: component testwith1speed_TM_packet_sender_0_0
     port map (
      ...
      i_RAD_DV => RAD_formatter_0_RAD_packet_DV,
      i_RAD_data(5015 downto 0) => RAD_formatter_0_RAD_packet(5015 downto 0),
      ...
      o_RAD_got => TM_packet_sender_0_o_RAD_got,
...
UART_RX_100MHZ_2: component testwith1speed_UART_RX_100MHZ_2_0
     port map (
      i_RX_Serial => UART_RAD_RX,
      led0 => NLW_UART_RX_100MHZ_2_led0_UNCONNECTED,
      o_RX_DV => UART_RX_100MHZ_2_o_RX_DV,
      o_RX_byte(7 downto 0) => UART_RX_100MHZ_2_o_RX_byte(7 downto 0),
      sysclk => sysclk
    );
