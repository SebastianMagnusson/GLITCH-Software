...
-- Date        : Wed Sep 24 16:14:12 2025
-- Host        : LAPTOP-1SQM85NC running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/GitHub/GLITCH-Software/FPGA/PCB/PCB_Test1_With1Speed/PCB_Test1_With1Speed.gen/sources_1/bd/testwith1speed/ip/testwith1speed_I2Cmod_0_0/testwith1speed_I2Cmod_0_0_sim_netlist.vhdl
-- Design      : testwith1speed_I2Cmod_0_0
...
entity testwith1speed_I2Cmod_0_0_I2Cmod is
  port (
  ...
  attribute ORIG_REF_NAME of testwith1speed_I2Cmod_0_0_I2Cmod : entity is "I2Cmod";
end testwith1speed_I2Cmod_0_0_I2Cmod;

architecture STRUCTURE of testwith1speed_I2Cmod_0_0_I2Cmod is
  ...
  attribute SOFT_HLUTNM of busy_i_3 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of busy_i_5 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of busy_i_6 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \count[1]_i_3\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \count[2]_i_3\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of scl_clk_i_2 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of sda_int_i_12 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of sda_int_i_20 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of stretch_i_4 : label is "soft_lutpair12";
begin
  ack_error <= \^ack_error\;
  busy <= \^busy\;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity testwith1speed_I2Cmod_0_0 is
  port (
    sda_i : in STD_LOGIC;
    sda_o : out STD_LOGIC;
    sda_t : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of testwith1speed_I2Cmod_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of testwith1speed_I2Cmod_0_0 : entity is "testwith1speed_I2Cmod_0_0,I2Cmod,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of testwith1speed_I2Cmod_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of testwith1speed_I2Cmod_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of testwith1speed_I2Cmod_0_0 : entity is "I2Cmod,Vivado 2024.2";
end testwith1speed_I2Cmod_0_0;

architecture STRUCTURE of testwith1speed_I2Cmod_0_0 is
...
U0: entity work.testwith1speed_I2Cmod_0_0_I2Cmod
     port map (
