...
(* CHECK_LICENSE_TYPE = "testwith1speed_I2C_full_sensor_data_0_0,I2C_full_sensor_data_fetcher,{}" *) (* core_generation_info = "testwith1speed_I2C_full_sensor_data_0_0,I2C_full_sensor_data_fetcher,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=I2C_full_sensor_data_fetcher,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VHDL,x_ipSimLanguage=VHDL,Clockfrequency=100000000}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* ip_definition_source = "module_ref" *) (* x_core_info = "I2C_full_sensor_data_fetcher,Vivado 2024.2" *) 
module testwith1speed_I2C_full_sensor_data_0_0(clk, rst, i_busy, i_data_read, i_TX_done_HK, 
