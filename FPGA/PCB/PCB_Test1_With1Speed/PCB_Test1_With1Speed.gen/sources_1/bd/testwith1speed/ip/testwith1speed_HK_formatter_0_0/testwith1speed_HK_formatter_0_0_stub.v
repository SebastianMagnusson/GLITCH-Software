...
//               c:/GitHub/GLITCH-Software/FPGA/PCB/PCB_Test1_With1Speed/PCB_Test1_With1Speed.gen/sources_1/bd/testwith1speed/ip/testwith1speed_HK_formatter_0_0/testwith1speed_HK_formatter_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "testwith1speed_HK_formatter_0_0,HK_formatter,{}" *) (* core_generation_info = "testwith1speed_HK_formatter_0_0,HK_formatter,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=HK_formatter,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VHDL,x_ipSimLanguage=VHDL,Clockfrequency=100000000,Baud_Rate=400000}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* ip_definition_source = "module_ref" *) (* x_core_info = "HK_formatter,Vivado 2024.2" *) 
module testwith1speed_HK_formatter_0_0(clk, rst, HK_packet_got, GNSS_data_DV, GNSS_data, 
