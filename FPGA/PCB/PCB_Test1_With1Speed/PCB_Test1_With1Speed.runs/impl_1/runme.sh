...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/PCB/PCB_Test1_With1Speed/PCB_Test1_With1Speed.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log testwith1speed_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source testwith1speed_wrapper.tcl -notrace
