...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/PCB/PCB_Test1_With1Speed/PCB_Test1_With1Speed.runs/testwith1speed_RW_ROUTER_100MHZ_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testwith1speed_RW_ROUTER_100MHZ_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testwith1speed_RW_ROUTER_100MHZ_0_0.tcl
