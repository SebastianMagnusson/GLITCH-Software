...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/PCB/PCB_Test1/PCB_Test1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PCB_Test1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PCB_Test1_wrapper.tcl
