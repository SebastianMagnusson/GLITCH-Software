...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/PCB/PCB_Test1/PCB_Test1.runs/PCB_Test1_I2C_full_sensor_data_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PCB_Test1_I2C_full_sensor_data_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PCB_Test1_I2C_full_sensor_data_0_0.tcl
