...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/PCB/PCB_Test1/PCB_Test1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PCB_Test1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PCB_Test1_wrapper.tcl -notrace
