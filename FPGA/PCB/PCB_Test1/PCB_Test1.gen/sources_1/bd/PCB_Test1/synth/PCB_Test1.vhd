...
--Date        : Tue Sep 23 13:12:29 2025
--Host        : LAPTOP-1SQM85NC running 64-bit major release  (build 9200)
--Command     : generate_target PCB_Test1.bd
--Design      : PCB_Test1
...
entity PCB_Test1 is
  ...
  attribute CORE_GENERATION_INFO of PCB_Test1 : entity is "PCB_Test1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=PCB_Test1,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=17,numReposBlks=17,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=17,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of PCB_Test1 : entity is "PCB_Test1.hwdef";
end PCB_Test1;

architecture STRUCTURE of PCB_Test1 is
  component PCB_Test1_BF_Data_Collector_Dr_0_0 is
  port (
    sysclk : in STD_LOGIC;
  ...
  end component PCB_Test1_BF_Data_Collector_Dr_0_0;
  component PCB_Test1_BF_formatter_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
  ...
  end component PCB_Test1_BF_formatter_0_0;
  component PCB_Test1_GNSS_Fetcher_mod_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
  ...
  end component PCB_Test1_GNSS_Fetcher_mod_0_0;
  component PCB_Test1_GNSS_Sender_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
    data_ready : in STD_LOGIC;
  ...
  end component PCB_Test1_GNSS_Sender_0_0;
  component PCB_Test1_HK_formatter_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
  ...
  end component PCB_Test1_HK_formatter_0_0;
  component PCB_Test1_I2C_full_sensor_data_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
    i_busy : in STD_LOGIC;
  ...
  end component PCB_Test1_I2C_full_sensor_data_0_0;
  component PCB_Test1_I2Cmod_0_0 is
  port (
    sda_i : in STD_LOGIC;
    sda_o : out STD_LOGIC;
    sda_t : out STD_LOGIC;
  ...
  end component PCB_Test1_I2Cmod_0_0;
  component PCB_Test1_Pulse_Per_Second_100_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
  ...
  end component PCB_Test1_Pulse_Per_Second_100_0_0;
  component PCB_Test1_Read1_100MHZ_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
  ...
  end component PCB_Test1_Read1_100MHZ_0_0;
  component PCB_Test1_RW_ROUTER_100MHZ_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
    led1 : out STD_LOGIC;
  ...
  end component PCB_Test1_RW_ROUTER_100MHZ_0_0;
  component PCB_Test1_Switchmod_0_0 is
  port (
    sysclk : in STD_LOGIC;
  ...
  end component PCB_Test1_Switchmod_0_0;
  component PCB_Test1_TM_packet_sender_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
  ...
  end component PCB_Test1_TM_packet_sender_0_0;
  component PCB_Test1_UART_RX_100MHZ_0_0 is
  port (
    sysclk : in STD_LOGIC;
  ...
  end component PCB_Test1_UART_RX_100MHZ_0_0;
  component PCB_Test1_UART_TX_100MHZ_0_0 is
  port (
    sysclk : in STD_LOGIC;
  ...
  end component PCB_Test1_UART_TX_100MHZ_0_0;
  component PCB_Test1_Write1_100MHZ_0_0 is
  port (
    sysclk : in STD_LOGIC;
    reset_n : in STD_LOGIC;
  ...
  end component PCB_Test1_Write1_100MHZ_0_0;
  component PCB_Test1_UART_RX_100MHZ_1_0 is
  port (
    sysclk : in STD_LOGIC;
    i_RX_Serial : in STD_LOGIC;
    o_RX_DV : out STD_LOGIC;
  ...
  end component PCB_Test1_UART_RX_100MHZ_1_0;
  component PCB_Test1_TC_distributor_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
  ...
  end component PCB_Test1_TC_distributor_0_0;
...
begin
BF_Data_Collector_Dr_0: component PCB_Test1_BF_Data_Collector_Dr_0_0
     port map (
...
BF_formatter_0: component PCB_Test1_BF_formatter_0_0
     port map (
...
GNSS_Fetcher_mod_0: component PCB_Test1_GNSS_Fetcher_mod_0_0
     port map (
...
GNSS_Sender_0: component PCB_Test1_GNSS_Sender_0_0
     port map (
...
HK_formatter_0: component PCB_Test1_HK_formatter_0_0
     port map (
...
I2C_full_sensor_data_0: component PCB_Test1_I2C_full_sensor_data_0_0
     port map (
      clk => sysclk,
      ...
      i_TX_done_HTR => HK_formatter_0_I2C_read_done,
      i_TX_done_RAD => HK_formatter_0_I2C_read_done,
...
I2Cmod_0: component PCB_Test1_I2Cmod_0_0
     port map (
...
Pulse_Per_Second_100_0: component PCB_Test1_Pulse_Per_Second_100_0_0
     port map (
...
RW_ROUTER_100MHZ_0: component PCB_Test1_RW_ROUTER_100MHZ_0_0
     port map (
...
Read1_100MHZ_0: component PCB_Test1_Read1_100MHZ_0_0
     port map (
...
Switchmod_0: component PCB_Test1_Switchmod_0_0
     port map (
...
TC_distributor_0: component PCB_Test1_TC_distributor_0_0
     port map (
...
TM_packet_sender_0: component PCB_Test1_TM_packet_sender_0_0
     port map (
      clk => sysclk,
...
UART_RX_100MHZ_0: component PCB_Test1_UART_RX_100MHZ_0_0
     port map (
      i_RX_Serial => GNSS_RX,
...
UART_RX_100MHZ_1: component PCB_Test1_UART_RX_100MHZ_1_0
     port map (
...
UART_TX_100MHZ_0: component PCB_Test1_UART_TX_100MHZ_0_0
     port map (
...
Write1_100MHZ_0: component PCB_Test1_Write1_100MHZ_0_0
     port map (
