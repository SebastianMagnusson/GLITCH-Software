...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/PCB/PCB_All_SRAM/PCB_All_SRAM.runs/PCB_All_SRAM_SAY_HEY_switchmod_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PCB_All_SRAM_SAY_HEY_switchmod_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PCB_All_SRAM_SAY_HEY_switchmod_0_0.tcl
