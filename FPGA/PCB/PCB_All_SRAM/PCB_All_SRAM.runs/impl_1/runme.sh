...
HD_PWD='C:/GitHub/GLITCH-Software/FPGA/PCB/PCB_All_SRAM/PCB_All_SRAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PCB_All_SRAM_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PCB_All_SRAM_wrapper.tcl -notrace
