...
entity PCB_All_SRAM is
  ...
  attribute CORE_GENERATION_INFO of PCB_All_SRAM : entity is "PCB_All_SRAM,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=PCB_All_SRAM,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=32,numReposBlks=32,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=32,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}";
...
architecture STRUCTURE of PCB_All_SRAM is
  ...
  component PCB_All_SRAM_RAD_formatter_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
  ...
  end component PCB_All_SRAM_RAD_formatter_0_0;
  ...
  component PCB_All_SRAM_UART_RX_100MHZ_2_0 is
  port (
    sysclk : in STD_LOGIC;
    i_RX_Serial : in STD_LOGIC;
    o_RX_DV : out STD_LOGIC;
  ...
  end component PCB_All_SRAM_UART_RX_100MHZ_2_0;
  ...
  signal NLW_RW_ROUTER_100MHZ_1_led1_UNCONNECTED : STD_LOGIC;
...
RAD_formatter_0: component PCB_All_SRAM_RAD_formatter_0_0
     port map (
...
RW_ROUTER_100MHZ_1: component PCB_All_SRAM_RW_ROUTER_100MHZ_1_0
     port map (
      ...
      led1 => NLW_RW_ROUTER_100MHZ_1_led1_UNCONNECTED,
      reset_n => Mode_control_0_o_signal,
      sysclk => sysclk
    );
...
UART_RX_100MHZ_2: component PCB_All_SRAM_UART_RX_100MHZ_2_0
     port map (
      i_RX_Serial => UART_RAD_TX,
      led0 => led2,
