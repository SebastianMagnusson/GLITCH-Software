...
--               c:/GitHub/GLITCH-Software/FPGA/PCB/PCB_All_SRAM/PCB_All_SRAM.gen/sources_1/bd/PCB_All_SRAM/ip/PCB_All_SRAM_UART_RX_100MHZ_1_0/PCB_All_SRAM_UART_RX_100MHZ_1_0_sim_netlist.vhdl
-- Design      : PCB_All_SRAM_UART_RX_100MHZ_1_0
...
entity PCB_All_SRAM_UART_RX_100MHZ_1_0_UART_RX_100MHZ is
  port (
  ...
  attribute ORIG_REF_NAME of PCB_All_SRAM_UART_RX_100MHZ_1_0_UART_RX_100MHZ : entity is "UART_RX_100MHZ";
end PCB_All_SRAM_UART_RX_100MHZ_1_0_UART_RX_100MHZ;

architecture STRUCTURE of PCB_All_SRAM_UART_RX_100MHZ_1_0_UART_RX_100MHZ is
  ...
  attribute SOFT_HLUTNM of \r_Clk_Count[1]_i_2\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \r_Clk_Count[8]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \r_Clk_Count[9]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \r_Clk_Count[9]_i_5\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \r_Clk_Count[9]_i_7\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \r_Clk_Count[9]_i_8\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \r_RX_Byte[7]_i_3\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \r_SM_Main[0]_i_4\ : label is "soft_lutpair8";
...
\r_Clk_Count[1]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00100000"
    )
        port map (
...
\r_Clk_Count[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8A888888AAAAAAAA"
        ...
        port map (
      I0 => \r_Clk_Count[9]_i_1_n_0\,
      I1 => \r_Clk_Count[9]_i_7_n_0\,
      I2 => \r_Clk_Count_reg_n_0_[1]\,
      I3 => \r_Clk_Count_reg_n_0_[0]\,
...
\r_Clk_Count[9]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \r_Clk_Count[9]_i_7_n_0\,
      I3 => \r_Clk_Count_reg_n_0_[9]\,
      I4 => \r_Clk_Count_reg_n_0_[8]\,
      I5 => \r_Clk_Count[9]_i_8_n_0\,
      O => \r_Clk_Count[9]_i_2_n_0\
    );
\r_Clk_Count[9]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
\r_Clk_Count[9]_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \r_SM_Main_reg_n_0_[1]\,
      I5 => \r_Clk_Count[9]_i_9_n_0\,
      O => \r_Clk_Count[9]_i_6_n_0\
    );
\r_Clk_Count[9]_i_7\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\r_Clk_Count[9]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FF7FFFFF"
    )
        port map (
      ...
      I2 => \r_Clk_Count_reg_n_0_[4]\,
      I3 => \r_Clk_Count[8]_i_3_n_0\,
      I4 => \r_Clk_Count_reg_n_0_[7]\,
      O => \r_Clk_Count[9]_i_8_n_0\
    );
\r_Clk_Count[9]_i_9\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity PCB_All_SRAM_UART_RX_100MHZ_1_0 is
  port (
    sysclk : in STD_LOGIC;
    i_RX_Serial : in STD_LOGIC;
    o_RX_DV : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of PCB_All_SRAM_UART_RX_100MHZ_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of PCB_All_SRAM_UART_RX_100MHZ_1_0 : entity is "PCB_All_SRAM_UART_RX_100MHZ_1_0,UART_RX_100MHZ,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of PCB_All_SRAM_UART_RX_100MHZ_1_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of PCB_All_SRAM_UART_RX_100MHZ_1_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of PCB_All_SRAM_UART_RX_100MHZ_1_0 : entity is "UART_RX_100MHZ,Vivado 2024.2";
end PCB_All_SRAM_UART_RX_100MHZ_1_0;

architecture STRUCTURE of PCB_All_SRAM_UART_RX_100MHZ_1_0 is
begin
U0: entity work.PCB_All_SRAM_UART_RX_100MHZ_1_0_UART_RX_100MHZ
     port map (
