...
--               c:/GitHub/GLITCH-Software/FPGA/PCB/PCB_All_SRAM/PCB_All_SRAM.gen/sources_1/bd/PCB_All_SRAM/ip/PCB_All_SRAM_TC_distributor_0_0/PCB_All_SRAM_TC_distributor_0_0_sim_netlist.vhdl
...
entity PCB_All_SRAM_TC_distributor_0_0_TC_distributor is
  port (
    led0 : out STD_LOGIC;
    cmd6 : out STD_LOGIC;
    cmd5 : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of PCB_All_SRAM_TC_distributor_0_0_TC_distributor : entity is "TC_distributor";
end PCB_All_SRAM_TC_distributor_0_0_TC_distributor;

architecture STRUCTURE of PCB_All_SRAM_TC_distributor_0_0_TC_distributor is
  ...
  signal cmd5_i_2_n_0 : STD_LOGIC;
  signal cmd5_i_3_n_0 : STD_LOGIC;
  signal \^cmd6\ : STD_LOGIC;
  signal cmd6_i_1_n_0 : STD_LOGIC;
  signal cmd6_i_2_n_0 : STD_LOGIC;
  signal cmd6_i_3_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of cmd0_i_3 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of cmd1_i_2 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of cmd3_i_3 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of cmd4_i_2 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of cmd5_i_3 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of cmd6_i_3 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of state_i_1 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \wait_cnt[0]_i_10\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \wait_cnt[0]_i_11\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \wait_cnt[0]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \wait_cnt[0]_i_9\ : label is "soft_lutpair1";
...
\TC_i[7]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
cmd3_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
cmd3_i_2: unisim.vcomponents.LUT6
    generic map(
...
cmd3_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
cmd5_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
cmd5_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
cmd6_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
cmd6_i_2: unisim.vcomponents.LUT6
    generic map(
...
cmd6_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\wait_cnt[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I1 => cmd6_i_2_n_0,
      I2 => \wait_cnt[0]_i_5_n_0\,
      I3 => state,
      I4 => \wait_cnt[0]_i_2_n_0\,
      O => \wait_cnt[0]_i_1_n_0\
    );
\wait_cnt[0]_i_10\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\wait_cnt[0]_i_12\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\wait_cnt[0]_i_13\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\wait_cnt[0]_i_14\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\wait_cnt[0]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFEFF7"
    )
        port map (
...
\wait_cnt[0]_i_5\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000100100"
        ...
        port map (
      I0 => TC_i(0),
      I1 => \wait_cnt[0]_i_10_n_0\,
      I2 => TC_i(6),
      I3 => TC_i(4),
      I4 => TC_i(5),
      I5 => \wait_cnt[0]_i_11_n_0\,
...
\wait_cnt[0]_i_7\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => wait_cnt_reg(18),
      I1 => wait_cnt_reg(17),
      I2 => \wait_cnt[0]_i_12_n_0\,
      I3 => \wait_cnt[0]_i_13_n_0\,
      I4 => \wait_cnt[0]_i_14_n_0\,
      I5 => \wait_cnt[0]_i_15_n_0\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity PCB_All_SRAM_TC_distributor_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
    TC : in STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute NotValidForBitStream of PCB_All_SRAM_TC_distributor_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of PCB_All_SRAM_TC_distributor_0_0 : entity is "PCB_All_SRAM_TC_distributor_0_0,TC_distributor,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of PCB_All_SRAM_TC_distributor_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of PCB_All_SRAM_TC_distributor_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of PCB_All_SRAM_TC_distributor_0_0 : entity is "TC_distributor,Vivado 2024.2";
end PCB_All_SRAM_TC_distributor_0_0;

architecture STRUCTURE of PCB_All_SRAM_TC_distributor_0_0 is
...
begin
U0: entity work.PCB_All_SRAM_TC_distributor_0_0_TC_distributor
     port map (
