...
--               c:/GitHub/GLITCH-Software/FPGA/PCB/PCB_All_SRAM/PCB_All_SRAM.gen/sources_1/bd/PCB_All_SRAM/ip/PCB_All_SRAM_Write_8SRAM_100MHZ_0_0/PCB_All_SRAM_Write_8SRAM_100MHZ_0_0_sim_netlist.vhdl
...
entity PCB_All_SRAM_Write_8SRAM_100MHZ_0_0_Write_8SRAM_100MHZ is
  port (
  ...
  attribute ORIG_REF_NAME of PCB_All_SRAM_Write_8SRAM_100MHZ_0_0_Write_8SRAM_100MHZ : entity is "Write_8SRAM_100MHZ";
end PCB_All_SRAM_Write_8SRAM_100MHZ_0_0_Write_8SRAM_100MHZ;

architecture STRUCTURE of PCB_All_SRAM_Write_8SRAM_100MHZ_0_0_Write_8SRAM_100MHZ is
  ...
  attribute SOFT_HLUTNM of \write_data[12]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \write_data[13]_i_1\ : label is "soft_lutpair5";
...
\write_data[12]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
entity PCB_All_SRAM_Write_8SRAM_100MHZ_0_0 is
  ...
  attribute NotValidForBitStream of PCB_All_SRAM_Write_8SRAM_100MHZ_0_0 : entity is true;
  ...
  attribute x_core_info of PCB_All_SRAM_Write_8SRAM_100MHZ_0_0 : entity is "Write_8SRAM_100MHZ,Vivado 2024.2";
end PCB_All_SRAM_Write_8SRAM_100MHZ_0_0;

architecture STRUCTURE of PCB_All_SRAM_Write_8SRAM_100MHZ_0_0 is
  signal \^dq_o\ : STD_LOGIC_VECTOR ( 11 downto 8 );
...
begin
  DQ_o(15 downto 12) <= \^dq_o\(11 downto 8);
  DQ_o(11 downto 8) <= \^dq_o\(11 downto 8);
  DQ_o(7) <= \^dq_o\(9);
  DQ_o(6 downto 4) <= \^dq_o\(10 downto 8);
  DQ_o(3 downto 0) <= \^dq_o\(11 downto 8);
  DQ_t(15) <= \^dq_t\(0);
  DQ_t(14) <= \^dq_t\(0);
  DQ_t(13) <= \^dq_t\(0);
  DQ_t(12) <= \^dq_t\(0);
  ...
  DQ_t(1) <= \^dq_t\(0);
  DQ_t(0) <= \^dq_t\(0);
U0: entity work.PCB_All_SRAM_Write_8SRAM_100MHZ_0_0_Write_8SRAM_100MHZ
     port map (
      A(21 downto 0) => A(21 downto 0),
      CE_n => CE_n,
      DQ_o(3 downto 0) => \^dq_o\(11 downto 8),
