...
architecture STRUCTURE of I2C_Test_Read_Sensorsmod_0_0_Read_Sensorsmod is
  ...
  signal \Main.busy_cnt[1]_i_6_n_0\ : STD_LOGIC;
  ...
  signal o_TX_DV_i_9_n_0 : STD_LOGIC;
  ...
  signal \o_i2c_data_wr[6]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[3]_i_10\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[3]_i_8\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \Main.busy_cnt[1]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \Main.busy_cnt[1]_i_4\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \Main.busy_cnt[1]_i_6\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \Main.busy_cnt[2]_i_3\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \Main.conv_cnt[0]_i_3\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \Main.sensor_cnt[0]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \Main.sensor_cnt[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \Main.sensor_cnt[1]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of TX_done_prev_i_1 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of o_TX_DV_i_7 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of o_TX_DV_i_8 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of o_TX_DV_i_9 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \o_TX_data[7]_i_4\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \o_TX_data[7]_i_7\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \o_i2c_address[3]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \o_i2c_address[4]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \o_i2c_address[5]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \o_i2c_address[6]_i_3\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \o_i2c_data_wr[3]_i_2\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \o_i2c_data_wr[7]_i_2\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \o_i2c_data_wr[7]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of o_i2c_ena_i_4 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of o_i2c_ena_i_6 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of o_i2c_rw_i_2 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of o_i2c_rw_i_3 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of o_i2c_rw_i_4 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of o_i2c_rw_i_6 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \temp_data[15]_i_2\ : label is "soft_lutpair9";
begin
  led2 <= \^led2\;
  o_TX_DV <= \^o_tx_dv\;
...
\Main.busy_cnt[1]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EE7EEEEE"
    )
        port map (
...
o_TX_DV_i_5: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000000030055FF55"
    )
        port map (
      I0 => state(2),
      I1 => o_i2c_ena_i_4_n_0,
...
o_TX_DV_i_9: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0075"
    )
        port map (
...
\o_i2c_data_wr[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\o_i2c_data_wr[6]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"111F1110"
    )
        port map (
      I0 => state(3),
      I1 => state(2),
      I2 => \o_i2c_data_wr[6]_i_2_n_0\,
      I3 => \o_i2c_address[6]_i_6_n_0\,
      I4 => \^o_i2c_data_wr\(1),
      O => \o_i2c_data_wr[6]_i_1_n_0\
    );
\o_i2c_data_wr[6]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
o_i2c_ena_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BAFFBA00"
    )
        port map (
