...
architecture STRUCTURE of I2C_Test_Read_Sensorsmod_0_0_Read_Sensorsmod is
  ...
  signal \Main.busy_cnt[2]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \alt_data[15]_i_2_n_0\ : STD_LOGIC;
  ...
  signal busy_prev_i_1_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_Main.mess_cnt_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \Main.busy_cnt[0]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \Main.busy_cnt[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \Main.busy_cnt[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \Main.busy_cnt[2]_i_2\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \Main.sensor_cnt[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \Main.sensor_cnt[1]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \alt_data[15]_i_2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \alt_data[23]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of led2_i_3 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of o_TX_DV_i_2 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of o_TX_DV_i_4 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of o_TX_DV_i_5 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \o_TX_data[7]_i_3\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \o_TX_data[7]_i_4\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \o_i2c_address[4]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \o_i2c_address[5]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \o_i2c_address[6]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \o_i2c_address[6]_i_3\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \o_i2c_data_wr[7]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of o_i2c_ena_i_3 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of o_i2c_ena_i_4 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of o_i2c_rw_i_2 : label is "soft_lutpair13";
...
\Main.busy_cnt[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FBBB0888"
    )
        port map (
...
\Main.busy_cnt[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7777774700000000"
    )
        port map (
...
\Main.busy_cnt[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FBBB0888"
    )
        port map (
...
\alt_data[15]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0002"
    )
        port map (
...
led2_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
led2_i_5: unisim.vcomponents.LUT6
    generic map(
...
led2_i_6: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
o_TX_DV_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0505FC00"
    )
        port map (
...
o_TX_DV_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\o_TX_data[7]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00400000"
    )
        port map (
...
\o_TX_data[7]_i_7\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"F0CCAAAA"
    )
        port map (
...
\o_TX_data[7]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAEEAAAA"
    )
        port map (
...
\o_TX_data[7]_i_9\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000B8B8BB88"
    )
        port map (
...
\o_i2c_data_wr[7]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
