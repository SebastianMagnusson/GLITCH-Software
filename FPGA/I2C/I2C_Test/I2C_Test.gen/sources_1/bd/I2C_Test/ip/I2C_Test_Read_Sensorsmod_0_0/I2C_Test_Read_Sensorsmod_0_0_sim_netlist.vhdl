...
architecture STRUCTURE of I2C_Test_Read_Sensorsmod_0_0_Read_Sensorsmod is
  ...
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[0]\ : label is "prep_alt:011,alt_read:0100,send_temp:010,temp:001,start:000,rtc:100,send_alt:0110,send_rtc:101,alt:0101";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[1]\ : label is "prep_alt:011,alt_read:0100,send_temp:010,temp:001,start:000,rtc:100,send_alt:0110,send_rtc:101,alt:0101";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[2]\ : label is "prep_alt:011,alt_read:0100,send_temp:010,temp:001,start:000,rtc:100,send_alt:0110,send_rtc:101,alt:0101";
  attribute SOFT_HLUTNM of \Main.busy_cnt[1]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \Main.busy_cnt[2]_i_2\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \Main.sensor_cnt[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \Main.sensor_cnt[1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of o_TX_DV_i_5 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of o_TX_DV_i_7 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \o_TX_data[7]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \o_TX_data[7]_i_6\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \o_TX_data[7]_i_7\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \o_TX_data[7]_i_8\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \o_i2c_address[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \o_i2c_address[4]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \o_i2c_address[5]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \o_i2c_address[6]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \o_i2c_address[6]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \o_i2c_data_wr[7]_i_1\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of o_i2c_rw_i_3 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \rtc_data[23]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \rtc_data[7]_i_2\ : label is "soft_lutpair8";
...
begin
  ...
  o_i2c_ena <= \^o_i2c_ena\;
  o_i2c_rw <= \^o_i2c_rw\;
\FSM_sequential_Main.mess_cnt_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F0DAF0F0F0F0F0F0"
    )
        port map (
      I0 => i_TX_done,
...
\Main.busy_cnt[1]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D2"
    )
        port map (
...
led2_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
o_TX_DV_i_5: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
o_TX_DV_i_7: unisim.vcomponents.LUT4
    generic map(
      INIT => X"5DF7"
    )
        port map (
...
\o_TX_data[7]_i_7\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\o_TX_data[7]_i_8\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\o_i2c_data_wr[6]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\o_i2c_data_wr[7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
o_i2c_rw_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"08001011"
    )
        port map (
...
o_i2c_rw_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"EEBEEEEEEEEEEEEE"
    )
        port map (
      I0 => state(1),
...
begin
  ...
  o_i2c_address(4) <= \^o_i2c_data_wr\(3);
  o_i2c_address(3) <= \^o_i2c_address\(3);
  o_i2c_address(2) <= \^o_i2c_data_wr\(3);
  o_i2c_address(1) <= \^o_i2c_data_wr\(3);
